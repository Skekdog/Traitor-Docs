...
Once published, you can now load the asset in Traitor! To do this, create a free private server in the [Labs](https://www.roblox.com/games/118757439615813/Labs) game, and join it. Once you have joined, you will have access to a console, where you can run commands to host your server.

To load a map, use the command: `map AssetId`<br/>
To load a gamemode, use: `gamemode AssetId`<br/>
To load a boss, use: `boss AssetId`<br/>
